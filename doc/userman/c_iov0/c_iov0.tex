...
multi-threaded \emph{C}/\emph{C++}-callable 
arith\-me\-tic/\-math\-e\-mat\-i\-cal/\-cryp\-to\-graph\-ic 
software library.

Although the library is microcontroller-centric, it is suitable for
personal computers.  The features of the library that make it suitable
for microcontrollers and embedded systems don't make it unsuitable for
