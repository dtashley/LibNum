...
%
%Miscellaneous typesetting definitions
\input{comps/worktypesetdefs}
%
...
%
%Product name; user manual title; part, chapter, and section titles
\input{comps/worktitlechapdefs}
%
\begin{document}
%
%index "see" definitions
\input{comps/workindexsees}
%
%Title page(s)
...
\part{\pgeninfolongtitle{}}
\label{pgeninfo}

% Chapter: Introduction and Overview
\input{c_iov0/c_iov0}

% Chapter: Detailed Description of LibNum
\input{c_ldd0/c_ldd0}

% Chapter: The LibNum Generator
\input{c_lgn0/c_lgn0}

% Part: Technical Background
\part{\ptechbackgroundlongtitle{}}
\label{ptechbackground}
...
\part{\plibdoclongtitle{}}
\label{plibdoc}

% Chapter: How to Use LibNum
\input{c_uuc0/c_uuc0}
...
%constrained area, and its common for titles too be too big to fit: the LaTeX
